...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CacheInfo.site'
        db.add_column(u'pam_cacheinfo', 'site',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CacheInfo.usr'
        db.add_column(u'pam_cacheinfo', 'usr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CacheInfo.site'
        db.delete_column(u'pam_cacheinfo', 'site')

        # Deleting field 'CacheInfo.usr'
        db.delete_column(u'pam_cacheinfo', 'usr')
    ...
    models = {
        u'pam.cacheinfo': {
            ...
            'usr': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'pam.classifyinfo': {
